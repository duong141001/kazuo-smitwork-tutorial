...
Mở file [`gallery.html`](gallery.html) bằng trình duyệt — trang tự chứa, không cần cài gì thêm.
...
| File | Vai trò |
|------|---------|
| `gallery.html` | Trang tài liệu tự chứa (mở bằng trình duyệt) |
| `shots/` | Ảnh chụp các màn hình |
| `capture-screens.mjs` | Script Playwright tự đăng nhập và chụp màn hình |
| `build-gallery.mjs` | Script dựng `gallery.html` từ ảnh + nội dung hướng dẫn |
...
node build-gallery.mjs     # dựng lại gallery.html
```
